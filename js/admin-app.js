...
async function calcularEstatisticasTurma() {
    ...
    try {
        ...
        if(document.getElementById('stat-prhf-plan')) document.getElementById('stat-prhf-plan').innerText = hPrhfPlan; 
        if(document.getElementById('stat-prhf-cump')) document.getElementById('stat-prhf-cump').innerText = hPrhfCump;
